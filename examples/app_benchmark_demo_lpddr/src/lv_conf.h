...
#define LV_ATTRIBUTE_LARGE_CONST __attribute__((section(".ExtMem.data")))

/*Compiler prefix for a big array declaration in RAM*/
#define LV_ATTRIBUTE_LARGE_RAM_ARRAY __attribute__((section(".ExtMem.bss")))__attribute__((aligned(4)))
